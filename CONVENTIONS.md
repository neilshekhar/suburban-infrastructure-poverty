...
- Do not commit `data/`, `outputs/`, GeoPackages, shapefiles, GeoJSON, CSV, Kepler HTML, or Kepler `map*.json` exports.
...
- Map A uses 2021-baseline metrics.
- Map B uses a 2010 baseline.
- Map B clamps pre-2010 facilities to `2010-01-01`.
- Map B drops facilities created after `2024-12-31`.
